...
public class questionWithRadioButtons extends LinearLayout {
	...
	public View inflator(String questionText,String[] radioButtonQuestions) {
		...
		setAnswerRadioButtons(radioButtonQuestions);
	...
	public void setAnswerRadioButtons(String[] radioButtonQuestions) {
